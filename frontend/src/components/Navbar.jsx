...
/**
 * Top navigation bar with branding, nav links, and user actions.
 */
    ...
    <header className="sticky top-0 z-30 w-full bg-white/80 backdrop-blur-md border-b border-surface-100 shadow-sm">
      <div className="flex items-center justify-between h-16 px-4 sm:px-6 lg:px-8">
        ...
        <div className="hidden md:flex flex-1 max-w-md mx-8">
          <div className="relative w-full">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2 text-sm bg-surface-50 border border-surface-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary-200 focus:border-primary-500 transition-all"
            />
          </div>
        </div>
        ...
        <div className="flex items-center gap-2">
          {/* Notifications */}
          <button className="p-2 rounded-lg text-surface-500 hover:bg-surface-100 hover:text-surface-700 transition-colors relative">
            <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
